...
export default function CultosView({ language, onChangeTab }: CultosViewProps) {
  ...
  return (
    <div id="cultos-view" className="animate-fade-in pt-20 bg-background text-on-background">
      ...
      <section id="localizacao" className="relative py-20 px-4 sm:px-6 lg:px-12 bg-surface-container overflow-hidden">
          ...
          <div className="bg-white p-8 sm:p-12 rounded-3xl shadow-xl border border-surface-container">
            ...
            <div className="space-y-4 mb-8">
              ...
              <p className="text-xs text-text-muted pl-8">
                {language === 'pt'
                  ? '✓ Acessibilidade com rampas e elevadores.'
                  : '✓ Accessibility with ramps and elevators.'}
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="https://maps.google.com/?q=Rua+Luis+Ant%C3%B4nio+dos+Santos+54+S%C3%A3o+Paulo"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 bg-primary text-white text-center py-3.5 rounded-xl font-bold text-sm hover:bg-primary-container transition-all cursor-pointer shadow block"
              >
